...
class LinkedList:
    ...
    def insert_node(self, p, new_node):
        if self.head is None:  # head가 없을때는
            self.head = new_node  # 새노드 삽입
        elif p is None:        # p(이전꺼)가 없을떄는
